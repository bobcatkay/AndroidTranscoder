...
#define FFMPEG_CONFIGURATION "--prefix=/home/fffmpeg/FFmpeg-Android/android/armv7-a --disable-encoders --disable-decoders --disable-avdevice --disable-static --disable-doc --disable-ffplay --disable-network --disable-doc --disable-symver --enable-neon --enable-shared --enable-libx264 --enable-gpl --enable-pic --enable-jni --enable-pthreads --enable-mediacodec --enable-encoder=aac --enable-encoder=gif --enable-encoder=libopenjpeg --enable-encoder=libmp3lame --enable-encoder=libwavpack --enable-encoder=libx264 --enable-encoder=mpeg4 --enable-encoder=pcm_s16le --enable-encoder=png --enable-encoder=srt --enable-encoder=subrip --enable-encoder=yuv4 --enable-encoder=text --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=libopenjpeg --enable-decoder=mp3 --enable-decoder=mpeg4_mediacodec --enable-decoder=pcm_s16le --enable-decoder=flac --enable-decoder=flv --enable-decoder=gif --enable-decoder=png --enable-decoder=srt --enable-decoder=xsub --enable-decoder=yuv4 --enable-decoder=vp8_mediacodec --enable-decoder=h264_mediacodec --enable-decoder=hevc_mediacodec --enable-hwaccel=h264_mediacodec --enable-hwaccel=mpeg4_mediacodec --enable-ffmpeg --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-bsf=hevc_mp4toannexb --enable-bsf=mpeg4_unpack_bframes --enable-cross-compile --cross-prefix=/home/ndk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --target-os=android --arch=arm --sysroot=/home/ndk/android-ndk-r15c/platforms/android-21/arch-arm/ --extra-cflags='-I/home/fffmpeg/FFmpeg-Android/x264/android/armv7-a/include -fPIE -pie -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags=-L/home/fffmpeg/FFmpeg-Android/x264/android/armv7-a/lib"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/home/fffmpeg/FFmpeg-Android/android/armv7-a/share/ffmpeg"
#define AVCONV_DATADIR "/home/fffmpeg/FFmpeg-Android/android/armv7-a/share/ffmpeg"
